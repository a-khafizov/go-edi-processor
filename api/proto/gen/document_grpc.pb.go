...
func (c *documentServiceClient) SendDocument(ctx context.Context, in *SendDocumentRequest, opts ...grpc.CallOption) (*SendDocumentResponse, error) {
...
func (c *documentServiceClient) GetDocumentByUUID(ctx context.Context, in *GetDocumentByUUIDRequest, opts ...grpc.CallOption) (*GetDocumentByUUIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDocumentByUUIDResponse)
	err := c.cc.Invoke(ctx, DocumentService_GetDocumentByUUID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDocumentServiceServer) SendDocument(context.Context, *SendDocumentRequest) (*SendDocumentResponse, error) {
...
func _DocumentService_GetDocumentByUUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDocumentByUUIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentService_GetDocumentByUUID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentServiceServer).GetDocumentByUUID(ctx, req.(*GetDocumentByUUIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DocumentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "go_edi_document_processor.DocumentService",
